...
public:
	...
	uint8                                        Pad_822[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	bool                                         bUseGenlockToCount;                                // 0x38(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_825[0x27];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	bool                                         bUseForSynchronization;                            // 0x30(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_857[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        FrameOffset;                                       // 0x34(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
