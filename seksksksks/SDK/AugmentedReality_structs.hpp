...
public:
	...
	uint8                                        Pad_4E2[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_4E5[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldTransform;                                    // 0x20(0x30)(BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_4ED[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4F2[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4F3[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
