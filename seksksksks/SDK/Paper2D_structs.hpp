...
public:
	...
	uint8                                        Pad_667[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_66D[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
